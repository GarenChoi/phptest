...
<?php    } ?>
                    ...
                    <div class="blog__pages">
                        <ul>
<?php
    $count = $connect -> query("SELECT * FROM myBlog WHERE blogDelete = 1") -> num_rows;
    ...
    if($page != 1){ 
        $prevPage = $page -1; ?>
            ...
            <li><a href="blog.php?page=<?=$prevPage?>">&lt;</a></li>
<?php } ?>
<?php 
    for($i=$startPage; $i<=$endPage; $i++){ 
        ...
        <li class="<?=$active?>"><a href="blog.php?page=<?=$i?>"><?=$i?></a></li>
<?php } ?>
<?php
    if($page != $boardCount){ 
        $nextPage = $page +1; ?>
        <li><a href="blog.php?page=<?=$nextPage?>">&gt;</a></li>
        <li><a href="blog.php?page=<?=$endPage?>">&gt;&gt;</a></li>
<?php } ?>
                        </ul>
                    </div>
                </div>
