        ...
        <section id="quiz-type" class="section center gray">
            <div class="container">
                ...
                <p class="section__desc">
                    퀴즈를 만들고 공유하고 공부할 수 있습니다.<br>
                    문제에 대한 저작권은 본인한테 있으며, 참고한 부분은 출처 부탁드립니다.
                </p>
                    ...
                    <div class="quiz__create">
                        <form action="quizCreateSave.php" name="quizCreate" method="post">
                            <fieldset>
                                ...
                                <div>
                                    <label for="quizDesc">문제에 대한 설명(해당 부분이 필요 없으면 안쓰셔도 됩니다.)</label>
                                ...
                                <div>
                                    ...
                                    <textarea name="quizComment" id="quizComment" placeholder="문제를 틀렸을 경우 이해할 수 있는 해설 부탁드립니다."></textarea>
                                </div>
                                <div>
                                    <label for="quizSource">출처 표시(출처가 있으면 작성해주세요!</label>
                                    <textarea name="quizSource" id="quizSource" placeholder="만약 문제를 인용하였다면 출처 표시 부탁드립니다!"></textarea>
                                </div>
                                <div class="quiz__btn">
