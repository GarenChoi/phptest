...
?>
            ...
            <section class="answer">
                ...
                <form action="#" class="answer__form" method="post">
                    <fieldset>
    ...
    <script>
        ...
        //     $(".answer__answer").text(view.answerContents);
        //     $(".answer__name").text(view.youNickName);
        ...
        function answerData(){
            let answerContents = $("textarea.answerContents").val();
            let boardID = $(".ask__contents").text();
            $.ajax({
                url: "boardTAnswerSave.php?boardID=<?=$boardID?>",
                method: "POST",
                data: {"answerContents": answerContents, "boardID":  <?=$askInfo['boardID']?>},
                dataType: "json",
                success: function(data){
                    // updateData(data.answer);
                },
        ...
        $("button.answer__btn").click(function(event){
            answerData();
