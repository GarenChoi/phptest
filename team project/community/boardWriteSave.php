<?php
    ...
    if(isset($boardThema)){
        if($boardThema == 'boardThemaQ'){
            ...
            $sql = "INSERT INTO teamBoardN(memberID, boardTitle, boardMeet, boardContents, boardLike, regTime) VALUES('$memberID', '$boardTitle', '$boardMeet', '$boardContents', '$boardLike','$regTime');";
            $result = $connect -> query($sql);
