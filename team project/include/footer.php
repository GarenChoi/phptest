        ...
        <div class="container">
            ...
            <div class="footer-menu">
                ...
                <div>
                    <h3>게시판 영역</h3>
                    <ul>
                        <li><a href="../community/boardQ.php">게시판</a></li>
                        <li><a href="../community/boardQModify.php">게시판 수정하기</a></li>
                        <li><a href="../community/boardQ.php">게시판 보기</a></li>
                        <li><a href="../community/boardWrite.php">게시판 쓰기</a></li>
                    </ul>
                </div>
                <div>
                    <h3>푸터 영역</h3>
            ...
            <address class="footer-rights">
                &copy;2022 GarenChoi. All rights reserved
            </address>
        </div>
    </footer>