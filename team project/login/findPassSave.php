<?php
    ...
    // 아이디 체크
    $sql = "SELECT youName, youEmail, youPhone, youPass FROM myTeam WHERE youName = '$youName' AND youEmail = '$youEmail' AND youPhone = '$youPhone'";
    ...
    if($findInfo['youName'] == $youName && $findInfo['youEmail'] == $youEmail && $findInfo['youPhone'] == $youPhone){
        ...
        echo "<script>alert('회원정보가 일치하지 않습니다. 다시 입력해 주세요!'); history.back(1)</script>";
    }
?>
                    ...
                    <fieldset>
                        ...
                        <div class="login-box">
                            ...
                            <div>
                                ...
                                <span class="comment" id="youPassComment"></span>
                                <input type="password" id="youPass" name="youPass" placeholder="비밀번호를 입력해주세요!" autocomplete="off" required>
                            </div>
                            <div class="mt30">
                                <label for="youPassC">비밀번호 확인</label>
                                <span class="comment" id="youPassCComment"></span>
                                <input type="password" id="youPassC" name="youPassC" placeholder="비밀번호를 다시 입력해주세요!" autocomplete="off" required>
                            </div>
                        </div>
                        <button id="findPassBtn" class="login-submit mt50" type="submit">비밀번호 변경</button>
                        <div class="other">
