...
<!-- // header -->
    <main id="contents">
        ...
        <section class="join-type defaultBg">
            <div class="member-form">
                <div class="logo"><img src="../img/Logo.png" alt="로고"></div>
                <h3>회원가입</h3>
                <div class="social">
                    <div class="google">
                        <a href=#><img src="../img/Google.png" alt="구글">구글</a></div>
                    <div class="naver">
                        <a href=#><img src="../img/Naver.png" alt="네이버">네이버</a></div>
                    <div class="kakao">
                        <a href=#><img src="../img/Kakao.png" alt="카카오톡">카카오톡</a></div>
                </div>
                <div class="or">Or</div>
                <form action="joinSave.php" name="join" method="post" onsubmit ="return joinChecks()">
                    <fieldset>
                        ...
                        <button id="joinBtn" class="join-submit" type="submit">회원가입 완료<a></button>
